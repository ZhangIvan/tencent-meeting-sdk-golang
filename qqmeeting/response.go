...
func (meeting Meeting) handleResponse(respBody []byte, descriptor *MeetingRequestDescriptor) (MeetingResponse, error) {
	...
	case RequestDescriptorUserCreate,
		...
		RequestDescriptorMeetLiveConfigUpdateByID,
		RequestDescriptorMeetLiveConfigUpdateByCode,
		RequestDescriptorMeetLiveDelete:
		// 返回的body为空
		return nil, nil
	...
	case RequestDescriptorLiveReplaysQueryByID, RequestDescriptorLiveReplaysQueryByCode:
		var resp LiveReplaysQueryByIDReply
		err = json.Unmarshal(respBody, &resp)
		response = resp
